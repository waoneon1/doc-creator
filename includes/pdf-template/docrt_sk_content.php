<?php
function docrt_sk_content($param, $meta, $post_term) {
    ...
    <table cellspacing="0" cellpadding="1" border="0">
        <tr>
           ...
           <td width="5%"> </td>
           <td width="5%">1.</td>
           <td width="60%"><p align="justify">Orang tersebut benar-benar penduduk Kelurahan Sawojajar Kec.Kedungkandang Kota Malang.</p></td>
        </tr>
        <tr>
           <td width="30%"> </td>
           <td width="5%"> </td>
           <td width="5%">2.</td>
           <td width="60%"><p align="justify">'.$param['b']['docrt_form_menerangkan_bahwa'].'</p>
           </td>
        </tr>
    </table>';
